...
import FormLegalBases from './Form/FormLegalBases'
...
import StepTwoMiddle from './StepTwo/StepTwoMiddle'
...
export default function StepForm({ setStep }) {
	...
	return (
		<div className="form-container vs-desktop-form">
						...
						<div className="form-col-2 pe-4">
							<div className="form-row">
								<div className="form-col">
									<div className="form-control">
										...
										<input placeholder="" type="text" name="fistName" id="fistName" value={inputFistName} onChange={handlerChangeFistName} />
								...
								<div className="form-col">
									<div className="form-control">
										...
										<input placeholder="" type="text" name="lastName" id="lastName" value={inputLastName} onChange={handlerChangeLastName} />
								...
								<div className="form-col">
									<div className="form-control">
										...
										<input placeholder="" type="text" name="rut" id="rut" value={inputRut} onChange={handlerChangeRut} />
								...
								<div className="form-col">
									<div className="form-control">
										...
										<input placeholder="" type="text" name="email" id="email" value={inputEmail} onChange={handlerChangeEmail} />
								...
								<div className="form-col">
									<div className="form-control">
										...
										<input placeholder="" type="text" name="phone" id="phone" value={inputPhone} onChange={handlerChangePhone} />
								...
								<div className="form-col">
									<div className="form-control">
										...
										<input placeholder="" type="text" name="number" id="number" value={inputNumber} onChange={handlerChangeNumber} />
							...
							<>
								<div className="form-row display-bigger">
									<div className="form-col-auto text-center">
										<FormModal />
									</div>
									<div className="form-col">
