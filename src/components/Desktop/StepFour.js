...
import roulette_bottles_bottom_image from '../../assets/Botella.png'
...
export default function StepFour({ setStep }) {
  ...
  const $bacardi = document.querySelector('.Bacardi')
	...
	useEffect(() => {
		$bacardi.style.backgroundImage = 'var(--roulette-main-bg)'
		$bacardi.style.backgroundPosition = 'center'
		return () => {
			$bacardi.style.backgroundImage = ''
		};
	}, [])
	return (
		<section id="stepFour" className="text-center">
			...
			<div className="left">
				<img src={roulette_bottles_bottom_image} alt="" className="img-fluid bottles" />
			</div>
			<div className="right">
				<img src={roulette_bottles_bottom_image} alt="" className="img-fluid bottles" />
			</div>
